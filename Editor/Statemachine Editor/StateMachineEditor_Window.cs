...
public class Styles{
    public Styles(GUIStyle _nodeStyle, GUIStyle _selectedNodeStyle, GUIStyle _inpointStyle, GUIStyle _outpointStyle){
        this.nodeStyle = _nodeStyle;
        this.selectedNodeStyle = _nodeStyle;
        this.inPointStyle = _inpointStyle;
        this.outPointStyle = _outpointStyle;
    }
...
public class StateMachineEditor_Window : EditorWindow
{
    ...
    {
        var window = GetWindow<StateMachineEditor_Window>();
